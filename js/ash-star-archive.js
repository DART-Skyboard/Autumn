...
(function() {
  ...
  function injectCSS(){
    ...
    s.textContent=[
      '#astar-trigger{position:fixed;right:0;top:214px;z-index:9498;display:flex;flex-direction:column;',
      ...
      '#astar-overlay{position:fixed;right:36px;top:206px;z-index:9399;width:min(280px, calc(100vw - 48px));',
